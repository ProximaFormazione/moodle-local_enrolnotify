...
$string['config_defaultsubject_desc'] = 'Oggetto usato laddove non specificato diversamente';
$string['config_defaultsubject_default'] = 'Iscrizione corso';
$string['config_defaultmessage'] = 'Messaggio di default';
$string['config_defaultmessage_desc'] = 'Messaggio usato laddove non specificato diversamente';
